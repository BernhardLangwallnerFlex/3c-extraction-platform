...
"8. Eine Zeile mit klar erkennbarer Leistung oder Medikament UND einem Preis → ein items-Eintrag. Zeilen ohne Preis (oder mit Preis 0) sind KEINE items. Wenn eine solche Zeile eine Diagnose, einen Befund oder eine klinische Beschreibung darstellt (z. B. 'Otitis externa', 'Ohren gesäubert und gespült', 'Verdacht auf Fraktur'), gehört sie in das Array 'diagnoses'. Rein erläuternde Zusätze zu einer Leistung (z. B. Dosierungshinweise) werden weder als item noch als Diagnose extrahiert.\n"
"8a. WICHTIG: Zeilen, die mit 'Diagnose:', 'Grund der Konsultation:', 'Diagnose/Grund der Konsultation:', 'Befund:' oder ähnlichem beginnen, sind NIEMALS items — auch nicht, wenn sie in einer Tabelle stehen oder einen Betrag 0.00 tragen. Sie gehören AUSSCHLIESSLICH in 'diagnoses' und dürfen NICHT zusätzlich als items-Eintrag dupliziert werden. Übernimm dabei nur den Diagnosetext ohne das Präfix (z. B. 'Grund der Konsultation: Nachbehandlung' → 'Nachbehandlung').\n"
